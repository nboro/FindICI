...
#         adam = Adam(lr=0.001, beta_1=0.9, beta_2=0.999, epsilon=1e-08, decay=0.0)
    ...
    def run_cnn(self):
        ...
        embed_matrix, num_of_words = self.create_emb_matrix(tokens_max, emb_size, word2vec, train_tokenizer)
...
#         test_tasks_pad=test_tasks_pad.reshape(test_tasks_pad.shape[0],test_tasks_pad.shape[1],1)
    ...
    def viz_loss_acc(self,history,module='all'):
        ...
        path_acc = 'accs/cnn_word2vec_acc_' + module + '.jpg'
        ...
        path_loss = 'loss/cnn_word2vec_loss_' + module + '.jpg'
...
#         val_tasks_padded=val_tasks_padded.reshape(val_tasks_padded.shape[0],val_tasks_padded.shape[1],1)
        ...
        # show the legend
        pyplot.legend()
        path = 'rocs/cnn_word2vec_roc_'+ module + '.jpg'
        pyplot.savefig(path)
        pyplot.clf()
...
if __name__ == "__main__":
    ...
    print(results_df)
    results_df.to_excel('cnn_word2vec.xlsx')