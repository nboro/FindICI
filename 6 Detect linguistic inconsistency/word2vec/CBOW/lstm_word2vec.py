...
class lstm:
    ...
    def viz_loss_acc(self,history,module='all'):
        ...
        path_acc = 'accs/lstm_word2vec_acc_' + module + '.jpg'
        ...
        path_loss = 'loss/lstm_word2vec_loss_' + module + '.jpg'
    ...
    def get_metrics(self,model_lstm,val_tasks_padded,module='all'):
        ...
        # show the legend
        pyplot.legend()
        path = 'rocs/lstm_word2vec_roc_'+ module + '.jpg'
        pyplot.savefig(path)
        pyplot.clf()
...
if __name__ == "__main__":
    ...
    for module in top10_list:
        ...
        mod_results = [matthews, accuracy, roc_auc, precision, recall, f1_score, precision_neg, recall_neg, f1_score_neg]
    ...
    print(results_df)
    results_df.to_excel('baseline_lstm.xlsx')