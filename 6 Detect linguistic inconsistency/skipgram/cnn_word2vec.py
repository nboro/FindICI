...
#         test_tasks_pad=test_tasks_pad.reshape(test_tasks_pad.shape[0],test_tasks_pad.shape[1],1)
    ...
    def viz_loss_acc(self,history,module='all'):
        ...
        path_acc = 'skip/cnn/cnn_word2vec_acc_' + module + '.jpg'
        ...
        path_loss = 'skip/cnn/cnn_word2vec_loss_' + module + '.jpg'
...
#         val_tasks_padded=val_tasks_padded.reshape(val_tasks_padded.shape[0],val_tasks_padded.shape[1],1)
        ...
        # show the legend
        pyplot.legend()
        path = 'skip/cnn/cnn_word2vec_roc_'+ module + '.jpg'
        pyplot.savefig(path)
        pyplot.clf()
...
if __name__ == "__main__":
    ...
    print(results_df)
    results_df.to_excel('skip/cnn_word2vec.xlsx')