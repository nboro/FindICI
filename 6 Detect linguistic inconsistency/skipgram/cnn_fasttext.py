...
class cnn:
    ...
    def viz_loss_acc(self, history, module='all'):
        ...
        path_acc = 'skip/cnn/cnn_fastext_acc_' + module + '.jpg'
        ...
        path_loss = 'skip/cnn/cnn_fastext_loss_' + module + '.jpg'
    ...
    def get_metrics(self, model_cnn, val_tasks_padded, module='all'):
        ...
        # show the legend
        pyplot.legend()
        path = 'skip/cnn/cnn_fastext_roc_' + module + '.jpg'
        pyplot.savefig(path)
        pyplot.clf()
...
if __name__ == "__main__":
    ...
    print(results_df)
    results_df.to_excel('skip/cnn_fastext.xlsx')