...
class xgboost:
    ...
    def run_xgboost(self):
        ...
        fastext, emb_size = self.fastextskip()
        
        train_data_vecs, test_data_vecs = self.prepare_train_test_tasks(fastext, emb_size)
...
if __name__ == "__main__":
    ...
    for module in top10_list:
        ...
        file_title = 'skip/xgb_best_params/xgb_fasttext_best_params_' + module + '.pkl'
        ...
        plt.title('ROC curve')
        plt.legend(loc='best')
        path = 'skip/xgb/xgb_fasttext_'+ module + '.jpg'
        plt.savefig(path)
        plt.clf()
    ...
    print(results_df)
    results_df.to_excel('skip/xgboost_fasttext.xlsx')