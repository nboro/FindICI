...
#         lstm_model.add(keras.layers.Lambda(lambda x: tf.reduce_mean(x, axis=1)))
#         lstm_model.add(LSTM(units = vector_size, dropout=0.2, recurrent_dropout=0.2, return_sequences=True, 
#                             input_shape=(max_tokens, 1)))
        lstm_model.add(LSTM(units = vector_size, dropout=0.2, recurrent_dropout=0.2))
...
#         sgd = SGD(lr=1e-2, decay=1e-6, momentum=0.9, nesterov=True)
    ...
    def run_lstm(self):
        ...
        print('LSTM model declaration done')
        print('==============')
...
#         test_tasks_pad=test_tasks_pad.reshape(test_tasks_pad.shape[0],test_tasks_pad.shape[1],1)
    ...
    def viz_loss_acc(self,history,module='all'):
        ...
        path_acc = 'skip/lstm/lstm_doc2vec_acc_' + module + '.jpg'
        ...
        path_loss = 'skip/lstm/lstm_doc2vec_loss_' + module + '.jpg'
...
#         val_tasks_padded=val_tasks_padded.reshape(val_tasks_padded.shape[0],val_tasks_padded.shape[1],1)
        ...
        # show the legend
        pyplot.legend()
        path = 'skip/lstm/lstm_doc2vec_roc_'+ module + '.jpg'
        pyplot.savefig(path)
        pyplot.clf()
...
if __name__ == "__main__":
    ...
    for module in top10_list:
        ...
        matthews, accuracy, precision, recall, f1_score, precision_neg, recall_neg, f1_score_neg, roc_auc = obj.get_metrics(lstm_model,
    ...
    print(results_df)
    results_df.to_excel('skip/lstm_doc2vec.xlsx')