...
class lstm:
    ...
    def viz_loss_acc(self, history, module='all'):
        ...
        path_acc = 'skip/lstm/lstm_fasttext_acc_' + module + '.jpg'
        ...
        path_loss = 'skip/lstm/lstm_fasttext_loss_' + module + '.jpg'
    ...
    def get_metrics(self, model_lstm, val_tasks_padded, module='all'):
        ...
        # show the legend
        pyplot.legend()
        path = '/skip/lstm/lstm_fasttext_roc_' + module + '.jpg'
        pyplot.savefig(path)
        pyplot.clf()
...
if __name__ == "__main__":
    ...
    print(results_df)
    results_df.to_excel('skip/lstm_fasttext.xlsx')