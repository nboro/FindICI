...
class xgboost:
    ...
    def run_xgboost(self):
        ...
        train_data_vecs = np.asarray(train_data_vecs)
        test_data_vecs = np.asarray(test_data_vecs)
...
if __name__ == "__main__":
    ...
    for module in top10_list:
        ...
        file_title = 'skip/xgb_best_params/xgb_doc2vec_best_params_' + module + '.pkl'
        ...
        plt.title('ROC curve')
        plt.legend(loc='best')
        path = 'skip/xgb/xgb_doc2vec_'+ module + '.jpg'
        plt.savefig(path)
        plt.clf()
    ...
    print(results_df)
    results_df.to_excel('skip/xgboost_doc2vec.xlsx')