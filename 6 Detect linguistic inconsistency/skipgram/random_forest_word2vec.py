...
if __name__ == "__main__":
    ...
    for module in top10_list:
        ...
        file_title = 'skip/rf_best_params/rf_word2vec_best_params_' + module + '.pkl'
        ...
        plt.title('ROC curve')
        plt.legend(loc='best')
        path = 'skip/rf/rf_word2vec_'+ module + '.jpg'
        plt.savefig(path)
        plt.clf()
    ...
    print(results_df)
    results_df.to_excel('skip/random_forest_word2vec.xlsx')